...
type MessageHandler func(packet *server.ClientPacket)
...
func (c *Client) OnCreatePlayerRsp(packet *server.ClientPacket) {
...
func (c *Client) OnLoginRsp(packet *server.ClientPacket) {
	rsp := &player.SCLogin{}
...
func (c *Client) OnAddFriendRsp(packet *server.ClientPacket) {
...
func (c *Client) OnDelFriendRsp(packet *server.ClientPacket) {
...
func (c *Client) OnSendChatMsgRsp(packet *server.ClientPacket) {
